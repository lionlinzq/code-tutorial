...
public class IdWorker {
    ...
    /**
     *
     * 本来不需要这个的，但是为了兼容有人直接new IdWorker
     */
    ...
    private void getWorkIdCfg() {
        workerId = Long.valueOf(System.getProperty("id.workerid", "1"));
        datacenterId = Long.valueOf(System.getProperty("id.datacenterid", "1"));
     ...
     */
    public long genId() {
        return IdWorkerHolder.idWorker.nextId();
    }
...
//		System.out.println("耗时"+(l2-l1)/1000 +"s");
    ...
    public static void setIdWorker(IdWorker idWorker) {
        ...
        IdWorkerHolder.idWorker=idWorker;
    }

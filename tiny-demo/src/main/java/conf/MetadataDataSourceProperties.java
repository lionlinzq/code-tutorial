...
@Component
@ConfigurationProperties(prefix = MetadataDataSourceProperties.PREFIX)
public class MetadataDataSourceProperties implements BeanClassLoaderAware {

    public static final String PREFIX = "xw.metadata";

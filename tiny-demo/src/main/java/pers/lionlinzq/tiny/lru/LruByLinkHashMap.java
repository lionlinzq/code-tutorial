...
/**
 * 按照访问和插入顺序排序，最近使用的排在后面
 *
 * @author lzq
 */
public class LruByLinkHashMap extends LinkedHashMap<Integer, Integer> {

    private final int capacity;

    public LruByLinkHashMap(int capacity) {
    ...
    public static void main(String[] args) {
        LruByLinkHashMap lruByLinkHashMap = new LruByLinkHashMap(3);

package pers.lionlinzq.function;
...
import pers.lionlinzq.annotation.LogRecordDiffField;
import pers.lionlinzq.annotation.LogRecordDiffObject;
import pers.lionlinzq.annotation.LogRecordFunc;
import pers.lionlinzq.bean.DiffDTO;
import pers.lionlinzq.bean.DiffFieldDTO;
import pers.lionlinzq.configuration.LogRecordProperties;
import pers.lionlinzq.context.LogRecordContext;
import pers.lionlinzq.exception.LogRecordException;
...
public class CustomFunctionObjectDiff {
    ...
    public CustomFunctionObjectDiff(LogRecordProperties logRecordProperties) {
        DIFF_MSG_FORMAT = logRecordProperties.getDiffMsgFormat().equals(DEFAULT_DIFF_MSG_FORMAT) ? DEFAULT_DIFF_MSG_FORMAT : logRecordProperties.getDiffMsgFormat();
        DIFF_MSG_SEPARATOR = logRecordProperties.getDiffMsgSeparator().equals(DEFAULT_DIFF_MSG_SEPARATOR) ? DEFAULT_DIFF_MSG_SEPARATOR : logRecordProperties.getDiffMsgSeparator();

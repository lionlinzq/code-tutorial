...
import pers.lionlinzq.service.IOperatorIdGetService;
import pers.lionlinzq.service.LogRecordErrorHandlerService;
import pers.lionlinzq.thread.LogRecordThreadPool;
...
public class SystemLogAspect {
    ...
    @Around("@annotation(pers.lionlinzq.annotation.OperationLog) || @annotation(pers.lionlinzq.annotation.OperationLogs)")
